...
export default function Layouts({ children }: {children: React.ReactNode}) {
  ...
  const cv_url = '../../public/erfan_ezizi_cv.pdf'
        ...
        <section>
          <nav className='flex py-10 mb-12 justify-between'>
            ...
            <ul className='flex items-center gap-5'>
              ...
              <li>
                <a className='bg-gradient-to-r from-amber-500 to-orange-500 text-zinc-50 px-4 py-2 rounded-md font-Silkscreen select-none' href={cv_url} attributes-list download>Download CV</a>
              </li>
            </ul>
          </nav>
        </section>
